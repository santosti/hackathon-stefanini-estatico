(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/animations'), require('@angular/platform-browser'), require('@angular/platform-browser/animations'), require('@angular/core'), require('rxjs/operators'), require('rxjs')) :
    typeof define === 'function' && define.amd ? define('angular-bootstrap-toasts', ['exports', '@angular/animations', '@angular/platform-browser', '@angular/platform-browser/animations', '@angular/core', 'rxjs/operators', 'rxjs'], factory) :
    (factory((global['angular-bootstrap-toasts'] = {}),global.ng.animations,global.ng.platformBrowser,global.ng.platformBrowser.animations,global.ng.core,global.rxjs.operators,global.rxjs));
}(this, (function (exports,animations,platformBrowser,animations$1,core,operators,rxjs) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var ToastMessage = /** @class */ (function () {
        function ToastMessage(params, systemParams) {
            this.confirmationResult = new rxjs.Subject();
    ...
    var AngularBootstrapToastsService = /** @class */ (function () {
        function AngularBootstrapToastsService() {
            this.toastsList = new rxjs.BehaviorSubject([]);
    ...
    var ToastsContainerComponent = /** @class */ (function () {
                        ...
                        animations: [
                            animations.trigger('enterAnimation', [
                                animations.transition(':enter', [
                                    ...
                                    animations.animate('350ms ease', animations.style({ transform: 'translateX(0)', opacity: 1 }))
                                ]),
                                animations.transition(':leave', [
                                    animations.style({ transform: 'translateX(0)', opacity: 1 }),
                                    animations.animate('300ms ease', animations.style({ transform: 'scale(0.1)', opacity: 0 }))
                                ])
                            ])
                        ],
        ...
        /** @nocollapse */
        ToastsContainerComponent.ctorParameters = function () {
            return [
    ...
    var ToastMessageComponent = /** @class */ (function () {
         ...
         */
            function () {
                ...
                this.durationTimer = rxjs.interval(this.msInterval).pipe(operators.filter(( /**
                 * @return {?}
                 */function () { return !_this.isMouseFocused; })), operators.tap(( /**
                 * @return {?}
                 */function () {
    ...
    exports.AngularBootstrapToastsService = AngularBootstrapToastsService;
    exports.ToastsContainerComponent = ToastsContainerComponent;
    exports.AngularBootstrapToastsModule = AngularBootstrapToastsModule;
    exports.ɵa = ToastMessageComponent;

    Object.defineProperty(exports, '__esModule', { value: true });

})));

//# sourceMappingURL=angular-bootstrap-toasts.umd.js.map